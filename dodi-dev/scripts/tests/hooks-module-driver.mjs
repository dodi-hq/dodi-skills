...
await expect("Main", "allow", "7b any fold of main is the lead, never a prefix ")
await expect("main [3fa9c1]", "allow", "7b main with a ref is the lead or a peer, never a prefix ")
